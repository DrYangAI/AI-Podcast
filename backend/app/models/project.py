...
class Project(Base):
    ...
    portrait_composite_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    portrait_bg_color: Mapped[str] = mapped_column(String(20), nullable=False, default="#1A1A2E")
    portrait_title_text: Mapped[str | None] = mapped_column(String(255), nullable=True)
    portrait_title_font_size: Mapped[int] = mapped_column(Integer, nullable=False, default=36)
    portrait_title_y: Mapped[int] = mapped_column(Integer, nullable=False, default=82)
